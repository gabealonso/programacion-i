...
//Este archivo responde con un objeto JSON, interpretado por javascript en el
//archivo html. No hace falta comprenderlo todo (aunque estaría bueno). Simplemente
//entender que el archivo "arma" un array, y lo muestra convertido en otro
//formato (JSON).
